...
// ArtInstituteOfChicago SDK utility: make_options

class ArtInstituteOfChicagoMakeOptions
{
    ...
    public static function call(ArtInstituteOfChicagoContext $ctx): array
    {
        ...
        //
        // `ArtInstituteOfChicagoSchema::optspec()` is built from the model:
        ...
        $optspec = ArtInstituteOfChicagoSchema::optspec();
