...
// ArtInstituteOfChicago SDK proxy feature
...
class ArtInstituteOfChicagoProxyFeature extends ArtInstituteOfChicagoBaseFeature
{
    ...
    public function init(ArtInstituteOfChicagoContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ArtInstituteOfChicagoContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
