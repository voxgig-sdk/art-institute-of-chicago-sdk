...
// ArtInstituteOfChicago SDK rbac feature
...
class ArtInstituteOfChicagoRbacFeature extends ArtInstituteOfChicagoBaseFeature
{
    ...
    private function _required(ArtInstituteOfChicagoContext $ctx): ?string
    {
    ...
    private function _reject(ArtInstituteOfChicagoContext $ctx, string $required): void
    {
    ...
    private function _track(ArtInstituteOfChicagoContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
