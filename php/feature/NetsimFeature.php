...
// ArtInstituteOfChicago SDK netsim feature
...
class ArtInstituteOfChicagoNetsimFeature extends ArtInstituteOfChicagoBaseFeature
{
    ...
    private function _simulate(ArtInstituteOfChicagoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ArtInstituteOfChicagoContext $ctx, array $applied): void
    {
        $client = $this->client;
