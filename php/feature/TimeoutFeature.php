...
// ArtInstituteOfChicago SDK timeout feature
...
class ArtInstituteOfChicagoTimeoutFeature extends ArtInstituteOfChicagoBaseFeature
{
    ...
    private function _with_timeout(ArtInstituteOfChicagoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ArtInstituteOfChicagoContext $_ctx, float $ms): void
    {
        $client = $this->client;
