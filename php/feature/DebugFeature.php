...
// ArtInstituteOfChicago SDK debug feature
...
class ArtInstituteOfChicagoDebugFeature extends ArtInstituteOfChicagoBaseFeature
{
    ...
    private function _finish(ArtInstituteOfChicagoContext $ctx, bool $ok): void
    {
