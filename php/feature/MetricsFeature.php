...
// ArtInstituteOfChicago SDK metrics feature
...
class ArtInstituteOfChicagoMetricsFeature extends ArtInstituteOfChicagoBaseFeature
{
    ...
    private function _record(ArtInstituteOfChicagoContext $ctx, bool $ok): void
    {
