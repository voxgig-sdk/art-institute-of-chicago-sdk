...
class PublicationEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ART_INSTITUTE_OF_CHICAGO_TEST_PUBLICATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $publication_ref01_data_dt0_load_result = Helpers::to_map(is_object($publication_ref01_data_dt0_loaded) && method_exists($publication_ref01_data_dt0_loaded, 'data_get') ? $publication_ref01_data_dt0_loaded->data_get() : $publication_ref01_data_dt0_loaded);
...
function publication_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ART_INSTITUTE_OF_CHICAGO_TEST_PUBLICATION_ENTID");
