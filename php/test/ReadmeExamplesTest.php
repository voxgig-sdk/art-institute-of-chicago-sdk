...
// ArtInstituteOfChicago SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ArtInstituteOfChicagoSDK::test)
...
{
    private const SDK_CLASS = 'ArtInstituteOfChicagoSDK';
    ...
    private const SDK_BASE = 'artinstituteofchicago_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../artinstituteofchicago_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
