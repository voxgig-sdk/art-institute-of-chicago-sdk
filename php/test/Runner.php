...
class ArtInstituteOfChicagoTestRunner
{
    ...
    {
        $live = self::getenv('ART_INSTITUTE_OF_CHICAGO_TEST_LIVE');
        $override = self::getenv('ART_INSTITUTE_OF_CHICAGO_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ART_INSTITUTE_OF_CHICAGO_TEST_EXPLAIN');
...
class_alias('ArtInstituteOfChicagoTestRunner', 'Runner');
class_alias('ArtInstituteOfChicagoHelpers', 'Helpers');
