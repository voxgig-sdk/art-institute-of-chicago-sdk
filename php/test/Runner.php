...
class ArtInstituteOfChicagoTestRunner
{
    ...
    {
        $live = self::getenv('ARTINSTITUTEOFCHICAGO_TEST_LIVE');
        $override = self::getenv('ARTINSTITUTEOFCHICAGO_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ARTINSTITUTEOFCHICAGO_TEST_EXPLAIN');
