...
class ImageEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ART_INSTITUTE_OF_CHICAGO_TEST_IMAGE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function image_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ART_INSTITUTE_OF_CHICAGO_TEST_IMAGE_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["ART_INSTITUTE_OF_CHICAGO_TEST_IMAGE_ENTID"]);
