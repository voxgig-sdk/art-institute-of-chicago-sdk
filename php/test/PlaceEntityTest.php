...
class PlaceEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ART_INSTITUTE_OF_CHICAGO_TEST_PLACE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function place_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ART_INSTITUTE_OF_CHICAGO_TEST_PLACE_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["ART_INSTITUTE_OF_CHICAGO_TEST_PLACE_ENTID"]);
