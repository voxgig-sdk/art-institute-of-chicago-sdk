...
// ArtInstituteOfChicago SDK EventProgram entity
...
class EventProgramEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EventProgramEntity($this->_client, $opts);
    }

    /**
     * @param EventProgram|array $args EventProgram data (assoc-array) to store.
     */
    ...
    /**
     * @return EventProgram|array The current EventProgram data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EventProgram fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EventProgram fields).
     */
    ...
    /**
     * Load a single EventProgram.
     *
     * @param EventProgramLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EventProgramLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EventProgram|array The loaded EventProgram as an assoc-array at the
    ...
    /**
     * List EventProgram items matching the given filter.
     *
     * @param EventProgramListMatch|array|null $reqmatch Match filter (any subset
     *   of EventProgram fields) as an assoc-array; EventProgramListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EventProgram[]|array A list of EventProgram items as assoc-arrays at
