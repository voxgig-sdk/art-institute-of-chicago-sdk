...
// ArtInstituteOfChicago SDK CategoryTerm entity
...
class CategoryTermEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CategoryTermEntity($this->_client, $opts);
    }

    /**
     * @param CategoryTerm|array $args CategoryTerm data (assoc-array) to store.
     */
    ...
    /**
     * @return CategoryTerm|array The current CategoryTerm data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CategoryTerm fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CategoryTerm fields).
     */
     ...
     *
     * @param CategoryTermLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CategoryTermLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CategoryTerm|array The loaded CategoryTerm as an assoc-array at the
     ...
     *
     * @param CategoryTermListMatch|array|null $reqmatch Match filter (any subset
     *   of CategoryTerm fields) as an assoc-array; CategoryTermListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CategoryTerm[]|array A list of CategoryTerm items as assoc-arrays at
