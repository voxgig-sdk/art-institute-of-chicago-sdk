...
// ArtInstituteOfChicago SDK Highlight entity
...
class HighlightEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HighlightEntity($this->_client, $opts);
    }

    /**
     * @param Highlight|array $args Highlight data (assoc-array) to store.
     */
    ...
    /**
     * @return Highlight|array The current Highlight data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Highlight fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Highlight fields).
     */
     ...
     *
     * @param HighlightLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed HighlightLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Highlight|array The loaded Highlight as an assoc-array at the
     ...
     *
     * @param HighlightListMatch|array|null $reqmatch Match filter (any subset
     *   of Highlight fields) as an assoc-array; HighlightListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Highlight[]|array A list of Highlight items as assoc-arrays at
