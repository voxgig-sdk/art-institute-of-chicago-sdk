...
// ArtInstituteOfChicago SDK LandingPage entity
...
class LandingPageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LandingPageEntity($this->_client, $opts);
    }

    /**
     * @param LandingPage|array $args LandingPage data (assoc-array) to store.
     */
    ...
    /**
     * @return LandingPage|array The current LandingPage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LandingPage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LandingPage fields).
     */
    ...
    /**
     * Load a single LandingPage.
     *
     * @param LandingPageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LandingPageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LandingPage|array The loaded LandingPage as an assoc-array at the
    ...
    /**
     * List LandingPage items matching the given filter.
     *
     * @param LandingPageListMatch|array|null $reqmatch Match filter (any subset
     *   of LandingPage fields) as an assoc-array; LandingPageListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LandingPage[]|array A list of LandingPage items as assoc-arrays at
