...
class VideoEntity
{
     ...
     *
     * @param VideoListMatch|array|null $reqmatch Match filter (any subset
     *   of Video fields) as an assoc-array; VideoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Video[]|array A list of Video items as assoc-arrays at
