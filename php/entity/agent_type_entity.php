...
// ArtInstituteOfChicago SDK AgentType entity
...
class AgentTypeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AgentTypeEntity($this->_client, $opts);
    }

    /**
     * @param AgentType|array $args AgentType data (assoc-array) to store.
     */
    ...
    /**
     * @return AgentType|array The current AgentType data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AgentType fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AgentType fields).
     */
    ...
    /**
     * Load a single AgentType.
     *
     * @param AgentTypeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AgentTypeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AgentType|array The loaded AgentType as an assoc-array at the
    ...
    /**
     * List AgentType items matching the given filter.
     *
     * @param AgentTypeListMatch|array|null $reqmatch Match filter (any subset
     *   of AgentType fields) as an assoc-array; AgentTypeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AgentType[]|array A list of AgentType items as assoc-arrays at
