...
// ArtInstituteOfChicago SDK DigitalPublication entity
...
class DigitalPublicationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "digital_publication";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DigitalPublicationEntity($this->_client, $opts);
    }

    /**
     * @param DigitalPublication|array $args DigitalPublication data (assoc-array) to store.
     */
    ...
    /**
     * @return DigitalPublication|array The current DigitalPublication data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DigitalPublication fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DigitalPublication fields).
     */
     ...
     *
     * @param DigitalPublicationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DigitalPublicationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DigitalPublication|array The loaded DigitalPublication as an assoc-array at the
     ...
     *
     * @param DigitalPublicationListMatch|array|null $reqmatch Match filter (any subset
     *   of DigitalPublication fields) as an assoc-array; DigitalPublicationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DigitalPublication[]|array A list of DigitalPublication items as assoc-arrays at
