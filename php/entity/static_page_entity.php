...
// ArtInstituteOfChicago SDK StaticPage entity
...
class StaticPageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StaticPageEntity($this->_client, $opts);
    }

    /**
     * @param StaticPage|array $args StaticPage data (assoc-array) to store.
     */
    ...
    /**
     * @return StaticPage|array The current StaticPage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of StaticPage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of StaticPage fields).
     */
    ...
    /**
     * Load a single StaticPage.
     *
     * @param StaticPageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StaticPageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StaticPage|array The loaded StaticPage as an assoc-array at the
    ...
    /**
     * List StaticPage items matching the given filter.
     *
     * @param StaticPageListMatch|array|null $reqmatch Match filter (any subset
     *   of StaticPage fields) as an assoc-array; StaticPageListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return StaticPage[]|array A list of StaticPage items as assoc-arrays at
