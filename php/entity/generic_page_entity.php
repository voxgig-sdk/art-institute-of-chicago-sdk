...
// ArtInstituteOfChicago SDK GenericPage entity
...
class GenericPageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GenericPageEntity($this->_client, $opts);
    }

    /**
     * @param GenericPage|array $args GenericPage data (assoc-array) to store.
     */
    ...
    /**
     * @return GenericPage|array The current GenericPage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GenericPage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GenericPage fields).
     */
    ...
    /**
     * Load a single GenericPage.
     *
     * @param GenericPageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GenericPageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GenericPage|array The loaded GenericPage as an assoc-array at the
    ...
    /**
     * List GenericPage items matching the given filter.
     *
     * @param GenericPageListMatch|array|null $reqmatch Match filter (any subset
     *   of GenericPage fields) as an assoc-array; GenericPageListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GenericPage[]|array A list of GenericPage items as assoc-arrays at
