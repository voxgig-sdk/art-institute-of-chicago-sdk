...
// ArtInstituteOfChicago SDK Gallery entity
...
class GalleryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GalleryEntity($this->_client, $opts);
    }

    /**
     * @param Gallery|array $args Gallery data (assoc-array) to store.
     */
    ...
    /**
     * @return Gallery|array The current Gallery data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Gallery fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Gallery fields).
     */
     ...
     *
     * @param GalleryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GalleryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Gallery|array The loaded Gallery as an assoc-array at the
    ...
    /**
     * List Gallery items matching the given filter.
     *
     * @param GalleryListMatch|array|null $reqmatch Match filter (any subset
     *   of Gallery fields) as an assoc-array; GalleryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Gallery[]|array A list of Gallery items as assoc-arrays at
