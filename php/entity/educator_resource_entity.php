...
class EducatorResourceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EducatorResourceEntity($this->_client, $opts);
    }

    /**
     * @param EducatorResource|array $args EducatorResource data (assoc-array) to store.
     */
    ...
    /**
     * @return EducatorResource|array The current EducatorResource data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EducatorResource fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EducatorResource fields).
     */
     ...
     *
     * @param EducatorResourceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EducatorResourceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EducatorResource|array The loaded EducatorResource as an assoc-array at the
     ...
     *
     * @param EducatorResourceListMatch|array|null $reqmatch Match filter (any subset
     *   of EducatorResource fields) as an assoc-array; EducatorResourceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EducatorResource[]|array A list of EducatorResource items as assoc-arrays at
