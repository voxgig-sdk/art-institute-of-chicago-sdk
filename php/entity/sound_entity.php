...
// ArtInstituteOfChicago SDK Sound entity
...
class SoundEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SoundEntity($this->_client, $opts);
    }

    /**
     * @param Sound|array $args Sound data (assoc-array) to store.
     */
    ...
    /**
     * @return Sound|array The current Sound data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Sound fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Sound fields).
     */
     ...
     * Load a single Sound.
     *
     * @param SoundLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SoundLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sound|array The loaded Sound as an assoc-array at the
     ...
     *
     * @param SoundListMatch|array|null $reqmatch Match filter (any subset
     *   of Sound fields) as an assoc-array; SoundListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sound[]|array A list of Sound items as assoc-arrays at
