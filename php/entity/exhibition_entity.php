...
class ExhibitionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ExhibitionEntity($this->_client, $opts);
    }

    /**
     * @param Exhibition|array $args Exhibition data (assoc-array) to store.
     */
    ...
    /**
     * @return Exhibition|array The current Exhibition data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Exhibition fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Exhibition fields).
     */
    ...
    /**
     * Load a single Exhibition.
     *
     * @param ExhibitionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ExhibitionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Exhibition|array The loaded Exhibition as an assoc-array at the
    ...
    /**
     * List Exhibition items matching the given filter.
     *
     * @param ExhibitionListMatch|array|null $reqmatch Match filter (any subset
     *   of Exhibition fields) as an assoc-array; ExhibitionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Exhibition[]|array A list of Exhibition items as assoc-arrays at
