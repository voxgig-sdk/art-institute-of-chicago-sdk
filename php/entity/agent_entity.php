...
// ArtInstituteOfChicago SDK Agent entity
...
class AgentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AgentEntity($this->_client, $opts);
    }

    /**
     * @param Agent|array $args Agent data (assoc-array) to store.
     */
    ...
    /**
     * @return Agent|array The current Agent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Agent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Agent fields).
     */
     ...
     * Load a single Agent.
     *
     * @param AgentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AgentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Agent|array The loaded Agent as an assoc-array at the
    ...
    /**
     * List Agent items matching the given filter.
     *
     * @param AgentListMatch|array|null $reqmatch Match filter (any subset
     *   of Agent fields) as an assoc-array; AgentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Agent[]|array A list of Agent items as assoc-arrays at
