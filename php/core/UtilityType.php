...
// ArtInstituteOfChicago SDK utility type

class ArtInstituteOfChicagoUtility
{
    ...
    public static function copy(ArtInstituteOfChicagoUtility $src): ArtInstituteOfChicagoUtility
    {
        $u = new ArtInstituteOfChicagoUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
