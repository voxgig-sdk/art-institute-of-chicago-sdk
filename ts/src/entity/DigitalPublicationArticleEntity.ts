...
class DigitalPublicationArticleEntity extends ArtInstituteOfChicagoEntityBase<DigitalPublicationArticle> {
  ...
  constructor(client: ArtInstituteOfChicagoSDK, entopts: any) {
    ...
    this.name = 'digital_publication_article'
    this.name_ = 'digital_publication_article'
    this.Name = 'DigitalPublicationArticle'
  }


  make(this: DigitalPublicationArticleEntity) {
    return new DigitalPublicationArticleEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: DigitalPublicationArticleLoadMatch, ctrl?: Control): Promise<DigitalPublicationArticleEntity> {
  ...
  async list(this: any, reqmatch?: DigitalPublicationArticleListMatch, ctrl?: Control): Promise<DigitalPublicationArticleEntity[]> {
