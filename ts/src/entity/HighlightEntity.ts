...
class HighlightEntity extends ArtInstituteOfChicagoEntityBase<Highlight> {
  ...
  constructor(client: ArtInstituteOfChicagoSDK, entopts: any) {
    ...
    this.name = 'highlight'
    this.name_ = 'highlight'
    this.Name = 'Highlight'
  }


  make(this: HighlightEntity) {
    return new HighlightEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: HighlightLoadMatch, ctrl?: Control): Promise<HighlightEntity> {
