...
class EventProgramEntity extends ArtInstituteOfChicagoEntityBase<EventProgram> {
  ...
  constructor(client: ArtInstituteOfChicagoSDK, entopts: any) {
    ...
    this.name = 'event_program'
    this.name_ = 'event_program'
    this.Name = 'EventProgram'
  }


  make(this: EventProgramEntity) {
    return new EventProgramEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: EventProgramLoadMatch, ctrl?: Control): Promise<EventProgramEntity> {
  ...
  async list(this: any, reqmatch?: EventProgramListMatch, ctrl?: Control): Promise<EventProgramEntity[]> {
