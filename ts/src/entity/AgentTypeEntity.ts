...
class AgentTypeEntity extends ArtInstituteOfChicagoEntityBase<AgentType> {
  ...
  constructor(client: ArtInstituteOfChicagoSDK, entopts: any) {
    ...
    this.name = 'agent_type'
    this.name_ = 'agent_type'
    this.Name = 'AgentType'
  }


  make(this: AgentTypeEntity) {
    return new AgentTypeEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: AgentTypeLoadMatch, ctrl?: Control): Promise<AgentTypeEntity> {
  ...
  async list(this: any, reqmatch?: AgentTypeListMatch, ctrl?: Control): Promise<AgentTypeEntity[]> {
