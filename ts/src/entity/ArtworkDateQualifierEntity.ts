...
class ArtworkDateQualifierEntity extends ArtInstituteOfChicagoEntityBase<ArtworkDateQualifier> {
  ...
  constructor(client: ArtInstituteOfChicagoSDK, entopts: any) {
    ...
    this.name = 'artwork_date_qualifier'
    this.name_ = 'artwork_date_qualifier'
    this.Name = 'ArtworkDateQualifier'
  }


  make(this: ArtworkDateQualifierEntity) {
    return new ArtworkDateQualifierEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: ArtworkDateQualifierLoadMatch, ctrl?: Control): Promise<ArtworkDateQualifierEntity> {
  ...
  async list(this: any, reqmatch?: ArtworkDateQualifierListMatch, ctrl?: Control): Promise<ArtworkDateQualifierEntity[]> {
