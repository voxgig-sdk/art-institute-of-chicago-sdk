...
class ArticleEntity extends ArtInstituteOfChicagoEntityBase<Article> {
  ...
  make(this: ArticleEntity) {
    return new ArticleEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: ArticleLoadMatch, ctrl?: Control): Promise<ArticleEntity> {
