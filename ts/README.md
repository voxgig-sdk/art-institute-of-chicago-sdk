...
The TypeScript SDK for the ArtInstituteOfChicago API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new ArtInstituteOfChicagoSDK({ apikey: '...' })
