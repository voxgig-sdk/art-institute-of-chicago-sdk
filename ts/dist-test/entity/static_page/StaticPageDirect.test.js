...
(0, node_test_1.describe)('StaticPageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-static_page', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-static_page', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-static_page', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-static_page', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ART_INSTITUTE_OF_CHICAGO_TEST_STATIC_PAGE_ENTID'];
...
//# sourceMappingURL=StaticPageDirect.test.js.map