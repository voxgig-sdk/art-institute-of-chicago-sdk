...
(0, node_test_1.describe)('SoundEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'sound.' + op, live))
                return;
        }
        ...
        let sound_ref01_data = Object.values(setup.data.existing.sound)[0];
        // LIST
        const sound_ref01_ent = client.Sound();
        const sound_ref01_match = {};
        const sound_ref01_list = (await sound_ref01_ent.list(sound_ref01_match)).map((e) => e.data());
        // LOAD
        const sound_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(sound_ref01_data_dt0.id === sound_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/sound/SoundTestData.json');
    ...
    let idmap = transform(['sound01', 'sound02', 'sound03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['ART_INSTITUTE_OF_CHICAGO_TEST_SOUND_ENTID'];
...
//# sourceMappingURL=SoundEntity.test.js.map