...
(0, node_test_1.describe)('VideoEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        const video_ref01_match = {};
        const video_ref01_list = (await video_ref01_ent.list(video_ref01_match)).map((e) => e.data());
        // LOAD
        const video_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(video_ref01_data_dt0.id === video_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['video01', 'video02', 'video03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const env = (0, utility_1.envOverride)({
        'ART_INSTITUTE_OF_CHICAGO_TEST_VIDEO_ENTID': idmap,
        'ART_INSTITUTE_OF_CHICAGO_TEST_LIVE': 'FALSE',
        'ART_INSTITUTE_OF_CHICAGO_TEST_EXPLAIN': 'FALSE',
    });
    idmap = env['ART_INSTITUTE_OF_CHICAGO_TEST_VIDEO_ENTID'];
    const live = 'TRUE' === env.ART_INSTITUTE_OF_CHICAGO_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['ART_INSTITUTE_OF_CHICAGO_TEST_VIDEO_ENTID'];
