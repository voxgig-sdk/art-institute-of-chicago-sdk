...
(0, node_test_1.describe)('LandingPageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-landing_page', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-landing_page', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-landing_page', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-landing_page', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ART_INSTITUTE_OF_CHICAGO_TEST_LANDING_PAGE_ENTID'];
...
//# sourceMappingURL=LandingPageDirect.test.js.map