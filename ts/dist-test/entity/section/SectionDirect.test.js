...
(0, node_test_1.describe)('SectionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-section', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-section', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-section', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-section', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ART_INSTITUTE_OF_CHICAGO_TEST_SECTION_ENTID'];
...
//# sourceMappingURL=SectionDirect.test.js.map