...
(0, node_test_1.describe)('EventOccurrenceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-event_occurrence', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-event_occurrence', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-event_occurrence', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-event_occurrence', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ART_INSTITUTE_OF_CHICAGO_TEST_EVENT_OCCURRENCE_ENTID'];
...
//# sourceMappingURL=EventOccurrenceDirect.test.js.map