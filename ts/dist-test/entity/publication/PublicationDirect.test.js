...
(0, node_test_1.describe)('PublicationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-publication', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-publication', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'ART_INSTITUTE_OF_CHICAGO_TEST_PUBLICATION_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['ART_INSTITUTE_OF_CHICAGO_TEST_PUBLICATION_ENTID'];
