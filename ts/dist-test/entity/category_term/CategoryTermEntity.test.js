...
(0, node_test_1.describe)('CategoryTermEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'category_term.' + op, live))
                return;
        }
        ...
        let category_term_ref01_data = Object.values(setup.data.existing.category_term)[0];
        // LIST
        const category_term_ref01_ent = client.CategoryTerm();
        const category_term_ref01_match = {};
        const category_term_ref01_list = (await category_term_ref01_ent.list(category_term_ref01_match)).map((e) => e.data());
        // LOAD
        const category_term_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(category_term_ref01_data_dt0.id === category_term_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/category_term/CategoryTermTestData.json');
    ...
    let idmap = transform(['category_term01', 'category_term02', 'category_term03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CategoryTermEntity.test.js.map