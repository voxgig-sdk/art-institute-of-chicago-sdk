...
(0, node_test_1.describe)('EventProgramEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let event_program_ref01_data = Object.values(setup.data.existing.event_program)[0];
        // LIST
        const event_program_ref01_ent = client.EventProgram();
        const event_program_ref01_match = {};
        const event_program_ref01_list = (await event_program_ref01_ent.list(event_program_ref01_match)).map((e) => e.data());
        // LOAD
        const event_program_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(event_program_ref01_data_dt0.id === event_program_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/event_program/EventProgramTestData.json');
    ...
    let idmap = transform(['event_program01', 'event_program02', 'event_program03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=EventProgramEntity.test.js.map