...
(0, node_test_1.describe)('ArtworkPlaceQualifierDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ArtInstituteOfChicagoSDK({
    ...
    (0, node_test_1.test)('direct-load-artwork_place_qualifier', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-artwork_place_qualifier', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-artwork_place_qualifier', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-artwork_place_qualifier', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.ART_INSTITUTE_OF_CHICAGO_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ArtInstituteOfChicagoSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['ART_INSTITUTE_OF_CHICAGO_TEST_ARTWORK_PLACE_QUALIFIER_ENTID'];
    ...
    const client = new __1.ArtInstituteOfChicagoSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ArtworkPlaceQualifierDirect.test.js.map