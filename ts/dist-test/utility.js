...
function envOverride(m) {
    if ('TRUE' === process.env.ART_INSTITUTE_OF_CHICAGO_TEST_LIVE ||
        'TRUE' === process.env.ART_INSTITUTE_OF_CHICAGO_TEST_OVERRIDE) {
    ...
    m.ART_INSTITUTE_OF_CHICAGO_TEST_EXPLAIN = process.env.ART_INSTITUTE_OF_CHICAGO_TEST_EXPLAIN || m.ART_INSTITUTE_OF_CHICAGO_TEST_EXPLAIN;
    return m;
}
