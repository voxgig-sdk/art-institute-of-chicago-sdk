...
exports.ArtInstituteOfChicagoEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends ArtInstituteOfChicagoEntityBase<Advice>`.
class ArtInstituteOfChicagoEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.ArtInstituteOfChicagoEntityBase = ArtInstituteOfChicagoEntityBase;
//# sourceMappingURL=ArtInstituteOfChicagoEntityBase.js.map