...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.ARTINSTITUTEOFCHICAGO_TEST_LIVE ||
    'TRUE' === process.env.ARTINSTITUTEOFCHICAGO_TEST_OVERRIDE
  ) {
  ...
  m.ARTINSTITUTEOFCHICAGO_TEST_EXPLAIN = process.env.ARTINSTITUTEOFCHICAGO_TEST_EXPLAIN || m.ARTINSTITUTEOFCHICAGO_TEST_EXPLAIN
