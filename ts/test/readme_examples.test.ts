...
//     (\`new ArtInstituteOfChicagoSDK(...)\` / \`ArtInstituteOfChicagoSDK.test(...)\` become
//     \`ArtInstituteOfChicagoSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'ArtInstituteOfChicagoSDK'
...
const TEST_SEED = {"entity":{"agent":{"test01":{"id":"test01"}},"agent_role":{"test01":{"id":"test01"}},"agent_type":{"test01":{"id":"test01"}},"article":{"test01":{"id":"test01"}},"artwork":{"test01":{"id":"test01"}},"artwork_date_qualifier":{"test01":{"id":"test01"}},"artwork_place_qualifier":{"test01":{"id":"test01"}},"artwork_type":{"test01":{"id":"test01"}},"category_term":{"test01":{"id":"test01"}},"digital_publication":{"test01":{"id":"test01"}},"digital_publication_article":{"test01":{"id":"test01"}},"educator_resource":{"test01":{"id":"test01"}},"event":{"test01":{"id":"test01"}},"event_occurrence":{"test01":{"id":"test01"}},"event_program":{"test01":{"id":"test01"}},"exhibition":{"test01":{"id":"test01"}},"gallery":{"test01":{"id":"test01"}},"generic_page":{"test01":{"id":"test01"}},"highlight":{"test01":{"id":"test01"}},"hour":{"test01":{"id":"test01"}},"image":{"test01":{"id":"test01"}},"landing_page":{"test01":{"id":"test01"}},"place":{"test01":{"id":"test01"}},"press_release":{"test01":{"id":"test01"}},"printed_publication":{"test01":{"id":"test01"}},"product":{"test01":{"id":"test01"}},"publication":{"test01":{"id":"test01"}},"search":{"test01":{"id":"test01"}},"section":{"test01":{"id":"test01"}},"site":{"test01":{"id":"test01"}},"sound":{"test01":{"id":"test01"}},"static_page":{"test01":{"id":"test01"}},"text":{"test01":{"id":"test01"}},"tour":{"test01":{"id":"test01"}},"video":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new ArtInstituteOfChicagoSDK(...)\` and any
// \`ArtInstituteOfChicagoSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+ArtInstituteOfChicagoSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/ArtInstituteOfChicagoSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
