...
type CategoryTermEntity struct {
	name    string
...
func NewCategoryTermEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *CategoryTermEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CategoryTermEntity) GetName() string { return e.name }
...
func (e *CategoryTermEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CategoryTermEntity) Deleted() bool {
	return e.deleted
}


func (e *CategoryTermEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCategoryTermEntity(e.client, opts)
}

func (e *CategoryTermEntity) Data(args ...any) any {
...
func (e *CategoryTermEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *CategoryTermEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CategoryTermEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *CategoryTermEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CategoryTermEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CategoryTermEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CategoryTermEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
