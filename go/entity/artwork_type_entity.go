...
func NewArtworkTypeEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *ArtworkTypeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ArtworkTypeEntity) GetName() string { return e.name }
...
func (e *ArtworkTypeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ArtworkTypeEntity) Deleted() bool {
	return e.deleted
}


func (e *ArtworkTypeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewArtworkTypeEntity(e.client, opts)
}

func (e *ArtworkTypeEntity) Data(args ...any) any {
...
func (e *ArtworkTypeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ArtworkTypeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ArtworkTypeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *ArtworkTypeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ArtworkTypeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ArtworkTypeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ArtworkTypeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
