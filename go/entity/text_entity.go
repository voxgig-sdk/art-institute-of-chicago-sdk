...
func NewTextEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *TextEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TextEntity) GetName() string { return e.name }
...
func (e *TextEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TextEntity) Deleted() bool {
	return e.deleted
}


func (e *TextEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTextEntity(e.client, opts)
}

func (e *TextEntity) Data(args ...any) any {
...
func (e *TextEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *TextEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TextEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *TextEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TextEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TextEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TextEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
