...
func NewArticleEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *ArticleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ArticleEntity) GetName() string { return e.name }
...
func (e *ArticleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ArticleEntity) Deleted() bool {
	return e.deleted
}


func (e *ArticleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewArticleEntity(e.client, opts)
}

func (e *ArticleEntity) Data(args ...any) any {
...
func (e *ArticleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Article; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ArticleEntity) DataTyped(data ...Article) Article {
	if len(data) > 0 {
		return typedFrom[Article](e.Data(asMap(data[0])))
	}
	return typedFrom[Article](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Article (all fields
// optional at the wire level).
func (e *ArticleEntity) MatchTyped(match ...Article) Article {
	if len(match) > 0 {
		return typedFrom[Article](e.Match(asMap(match[0])))
	}
	return typedFrom[Article](e.Match())
}
...
func (e *ArticleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ArticleEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ArticleLoadMatch and returns an Article. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ArticleEntity) LoadTyped(reqmatch ArticleLoadMatch, ctrl map[string]any) (Article, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Article{}, err
	}
	return typedFrom[Article](res), nil
}




func (e *ArticleEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ArticleListMatch and returns []Article. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ArticleEntity) ListTyped(reqmatch ArticleListMatch, ctrl map[string]any) ([]Article, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Article](res), nil
}



func (e *ArticleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ArticleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ArticleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ArticleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
