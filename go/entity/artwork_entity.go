...
func NewArtworkEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *ArtworkEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ArtworkEntity) GetName() string { return e.name }
...
func (e *ArtworkEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ArtworkEntity) Deleted() bool {
	return e.deleted
}


func (e *ArtworkEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewArtworkEntity(e.client, opts)
}

func (e *ArtworkEntity) Data(args ...any) any {
...
func (e *ArtworkEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Artwork; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ArtworkEntity) DataTyped(data ...Artwork) Artwork {
	if len(data) > 0 {
		return typedFrom[Artwork](e.Data(asMap(data[0])))
	}
	return typedFrom[Artwork](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Artwork (all fields
// optional at the wire level).
func (e *ArtworkEntity) MatchTyped(match ...Artwork) Artwork {
	if len(match) > 0 {
		return typedFrom[Artwork](e.Match(asMap(match[0])))
	}
	return typedFrom[Artwork](e.Match())
}
...
func (e *ArtworkEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ArtworkEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ArtworkLoadMatch and returns an Artwork. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ArtworkEntity) LoadTyped(reqmatch ArtworkLoadMatch, ctrl map[string]any) (Artwork, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Artwork{}, err
	}
	return typedFrom[Artwork](res), nil
}




func (e *ArtworkEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ArtworkListMatch and returns []Artwork. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ArtworkEntity) ListTyped(reqmatch ArtworkListMatch, ctrl map[string]any) ([]Artwork, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Artwork](res), nil
}



func (e *ArtworkEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ArtworkEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ArtworkEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ArtworkEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
