...
func NewSectionEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *SectionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SectionEntity) GetName() string { return e.name }
...
func (e *SectionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SectionEntity) Deleted() bool {
	return e.deleted
}


func (e *SectionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSectionEntity(e.client, opts)
}

func (e *SectionEntity) Data(args ...any) any {
...
func (e *SectionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Section; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SectionEntity) DataTyped(data ...Section) Section {
	if len(data) > 0 {
		return typedFrom[Section](e.Data(asMap(data[0])))
	}
	return typedFrom[Section](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Section (all fields
// optional at the wire level).
func (e *SectionEntity) MatchTyped(match ...Section) Section {
	if len(match) > 0 {
		return typedFrom[Section](e.Match(asMap(match[0])))
	}
	return typedFrom[Section](e.Match())
}
...
func (e *SectionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SectionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SectionLoadMatch and returns an Section. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SectionEntity) LoadTyped(reqmatch SectionLoadMatch, ctrl map[string]any) (Section, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Section{}, err
	}
	return typedFrom[Section](res), nil
}




func (e *SectionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// SectionListMatch and returns []Section. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SectionEntity) ListTyped(reqmatch SectionListMatch, ctrl map[string]any) ([]Section, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Section](res), nil
}



func (e *SectionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SectionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SectionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SectionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
