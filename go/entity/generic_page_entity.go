...
func NewGenericPageEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *GenericPageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GenericPageEntity) GetName() string { return e.name }
...
func (e *GenericPageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GenericPageEntity) Deleted() bool {
	return e.deleted
}


func (e *GenericPageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGenericPageEntity(e.client, opts)
}

func (e *GenericPageEntity) Data(args ...any) any {
...
func (e *GenericPageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GenericPage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GenericPageEntity) DataTyped(data ...GenericPage) GenericPage {
	if len(data) > 0 {
		return typedFrom[GenericPage](e.Data(asMap(data[0])))
	}
	return typedFrom[GenericPage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GenericPage (all fields
// optional at the wire level).
func (e *GenericPageEntity) MatchTyped(match ...GenericPage) GenericPage {
	if len(match) > 0 {
		return typedFrom[GenericPage](e.Match(asMap(match[0])))
	}
	return typedFrom[GenericPage](e.Match())
}
...
func (e *GenericPageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GenericPageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GenericPageLoadMatch and returns an GenericPage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GenericPageEntity) LoadTyped(reqmatch GenericPageLoadMatch, ctrl map[string]any) (GenericPage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GenericPage{}, err
	}
	return typedFrom[GenericPage](res), nil
}




func (e *GenericPageEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// GenericPageListMatch and returns []GenericPage. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GenericPageEntity) ListTyped(reqmatch GenericPageListMatch, ctrl map[string]any) ([]GenericPage, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GenericPage](res), nil
}



func (e *GenericPageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GenericPageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GenericPageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GenericPageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
