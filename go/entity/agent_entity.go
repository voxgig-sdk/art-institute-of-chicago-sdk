...
func NewAgentEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *AgentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AgentEntity) GetName() string { return e.name }
...
func (e *AgentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AgentEntity) Deleted() bool {
	return e.deleted
}


func (e *AgentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAgentEntity(e.client, opts)
}

func (e *AgentEntity) Data(args ...any) any {
...
func (e *AgentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Agent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AgentEntity) DataTyped(data ...Agent) Agent {
	if len(data) > 0 {
		return typedFrom[Agent](e.Data(asMap(data[0])))
	}
	return typedFrom[Agent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Agent (all fields
// optional at the wire level).
func (e *AgentEntity) MatchTyped(match ...Agent) Agent {
	if len(match) > 0 {
		return typedFrom[Agent](e.Match(asMap(match[0])))
	}
	return typedFrom[Agent](e.Match())
}
...
func (e *AgentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AgentEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AgentLoadMatch and returns an Agent. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AgentEntity) LoadTyped(reqmatch AgentLoadMatch, ctrl map[string]any) (Agent, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Agent{}, err
	}
	return typedFrom[Agent](res), nil
}




func (e *AgentEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// AgentListMatch and returns []Agent. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AgentEntity) ListTyped(reqmatch AgentListMatch, ctrl map[string]any) ([]Agent, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Agent](res), nil
}



func (e *AgentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AgentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AgentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AgentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
