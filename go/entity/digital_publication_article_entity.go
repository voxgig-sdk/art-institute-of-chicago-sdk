...
type DigitalPublicationArticleEntity struct {
	name    string
...
func NewDigitalPublicationArticleEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *DigitalPublicationArticleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &DigitalPublicationArticleEntity{
...
func (e *DigitalPublicationArticleEntity) GetName() string { return e.name }
...
func (e *DigitalPublicationArticleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DigitalPublicationArticleEntity) Deleted() bool {
	return e.deleted
}


func (e *DigitalPublicationArticleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDigitalPublicationArticleEntity(e.client, opts)
}

func (e *DigitalPublicationArticleEntity) Data(args ...any) any {
...
func (e *DigitalPublicationArticleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *DigitalPublicationArticleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DigitalPublicationArticleEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *DigitalPublicationArticleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DigitalPublicationArticleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DigitalPublicationArticleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DigitalPublicationArticleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
