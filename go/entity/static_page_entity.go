...
func NewStaticPageEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *StaticPageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StaticPageEntity) GetName() string { return e.name }
...
func (e *StaticPageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StaticPageEntity) Deleted() bool {
	return e.deleted
}


func (e *StaticPageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStaticPageEntity(e.client, opts)
}

func (e *StaticPageEntity) Data(args ...any) any {
...
func (e *StaticPageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an StaticPage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StaticPageEntity) DataTyped(data ...StaticPage) StaticPage {
	if len(data) > 0 {
		return typedFrom[StaticPage](e.Data(asMap(data[0])))
	}
	return typedFrom[StaticPage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through StaticPage (all fields
// optional at the wire level).
func (e *StaticPageEntity) MatchTyped(match ...StaticPage) StaticPage {
	if len(match) > 0 {
		return typedFrom[StaticPage](e.Match(asMap(match[0])))
	}
	return typedFrom[StaticPage](e.Match())
}
...
func (e *StaticPageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StaticPageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StaticPageLoadMatch and returns an StaticPage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *StaticPageEntity) LoadTyped(reqmatch StaticPageLoadMatch, ctrl map[string]any) (StaticPage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return StaticPage{}, err
	}
	return typedFrom[StaticPage](res), nil
}




func (e *StaticPageEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// StaticPageListMatch and returns []StaticPage. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *StaticPageEntity) ListTyped(reqmatch StaticPageListMatch, ctrl map[string]any) ([]StaticPage, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[StaticPage](res), nil
}



func (e *StaticPageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StaticPageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StaticPageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StaticPageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
