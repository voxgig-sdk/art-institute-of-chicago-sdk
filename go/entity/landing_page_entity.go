...
func NewLandingPageEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *LandingPageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LandingPageEntity) GetName() string { return e.name }
...
func (e *LandingPageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LandingPageEntity) Deleted() bool {
	return e.deleted
}


func (e *LandingPageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLandingPageEntity(e.client, opts)
}

func (e *LandingPageEntity) Data(args ...any) any {
...
func (e *LandingPageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LandingPage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LandingPageEntity) DataTyped(data ...LandingPage) LandingPage {
	if len(data) > 0 {
		return typedFrom[LandingPage](e.Data(asMap(data[0])))
	}
	return typedFrom[LandingPage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LandingPage (all fields
// optional at the wire level).
func (e *LandingPageEntity) MatchTyped(match ...LandingPage) LandingPage {
	if len(match) > 0 {
		return typedFrom[LandingPage](e.Match(asMap(match[0])))
	}
	return typedFrom[LandingPage](e.Match())
}
...
func (e *LandingPageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LandingPageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LandingPageLoadMatch and returns an LandingPage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LandingPageEntity) LoadTyped(reqmatch LandingPageLoadMatch, ctrl map[string]any) (LandingPage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return LandingPage{}, err
	}
	return typedFrom[LandingPage](res), nil
}




func (e *LandingPageEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// LandingPageListMatch and returns []LandingPage. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LandingPageEntity) ListTyped(reqmatch LandingPageListMatch, ctrl map[string]any) ([]LandingPage, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[LandingPage](res), nil
}



func (e *LandingPageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LandingPageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LandingPageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LandingPageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
