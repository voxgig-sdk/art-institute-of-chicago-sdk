...
func NewExhibitionEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *ExhibitionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ExhibitionEntity) GetName() string { return e.name }
...
func (e *ExhibitionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ExhibitionEntity) Deleted() bool {
	return e.deleted
}


func (e *ExhibitionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewExhibitionEntity(e.client, opts)
}

func (e *ExhibitionEntity) Data(args ...any) any {
...
func (e *ExhibitionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Exhibition; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ExhibitionEntity) DataTyped(data ...Exhibition) Exhibition {
	if len(data) > 0 {
		return typedFrom[Exhibition](e.Data(asMap(data[0])))
	}
	return typedFrom[Exhibition](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Exhibition (all fields
// optional at the wire level).
func (e *ExhibitionEntity) MatchTyped(match ...Exhibition) Exhibition {
	if len(match) > 0 {
		return typedFrom[Exhibition](e.Match(asMap(match[0])))
	}
	return typedFrom[Exhibition](e.Match())
}
...
func (e *ExhibitionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ExhibitionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ExhibitionLoadMatch and returns an Exhibition. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ExhibitionEntity) LoadTyped(reqmatch ExhibitionLoadMatch, ctrl map[string]any) (Exhibition, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Exhibition{}, err
	}
	return typedFrom[Exhibition](res), nil
}




func (e *ExhibitionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ExhibitionListMatch and returns []Exhibition. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ExhibitionEntity) ListTyped(reqmatch ExhibitionListMatch, ctrl map[string]any) ([]Exhibition, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Exhibition](res), nil
}



func (e *ExhibitionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ExhibitionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ExhibitionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ExhibitionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
