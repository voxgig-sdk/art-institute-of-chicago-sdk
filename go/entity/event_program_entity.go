...
type EventProgramEntity struct {
	name    string
...
func NewEventProgramEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *EventProgramEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EventProgramEntity) GetName() string { return e.name }
...
func (e *EventProgramEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EventProgramEntity) Deleted() bool {
	return e.deleted
}


func (e *EventProgramEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEventProgramEntity(e.client, opts)
}

func (e *EventProgramEntity) Data(args ...any) any {
...
func (e *EventProgramEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EventProgram; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EventProgramEntity) DataTyped(data ...EventProgram) EventProgram {
	if len(data) > 0 {
		return typedFrom[EventProgram](e.Data(asMap(data[0])))
	}
	return typedFrom[EventProgram](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EventProgram (all fields
// optional at the wire level).
func (e *EventProgramEntity) MatchTyped(match ...EventProgram) EventProgram {
	if len(match) > 0 {
		return typedFrom[EventProgram](e.Match(asMap(match[0])))
	}
	return typedFrom[EventProgram](e.Match())
}
...
func (e *EventProgramEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EventProgramEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EventProgramLoadMatch and returns an EventProgram. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EventProgramEntity) LoadTyped(reqmatch EventProgramLoadMatch, ctrl map[string]any) (EventProgram, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return EventProgram{}, err
	}
	return typedFrom[EventProgram](res), nil
}




func (e *EventProgramEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// EventProgramListMatch and returns []EventProgram. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EventProgramEntity) ListTyped(reqmatch EventProgramListMatch, ctrl map[string]any) ([]EventProgram, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[EventProgram](res), nil
}



func (e *EventProgramEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EventProgramEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EventProgramEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EventProgramEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
