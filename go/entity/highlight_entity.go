...
func NewHighlightEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *HighlightEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HighlightEntity) GetName() string { return e.name }
...
func (e *HighlightEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HighlightEntity) Deleted() bool {
	return e.deleted
}


func (e *HighlightEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHighlightEntity(e.client, opts)
}

func (e *HighlightEntity) Data(args ...any) any {
...
func (e *HighlightEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Highlight; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HighlightEntity) DataTyped(data ...Highlight) Highlight {
	if len(data) > 0 {
		return typedFrom[Highlight](e.Data(asMap(data[0])))
	}
	return typedFrom[Highlight](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Highlight (all fields
// optional at the wire level).
func (e *HighlightEntity) MatchTyped(match ...Highlight) Highlight {
	if len(match) > 0 {
		return typedFrom[Highlight](e.Match(asMap(match[0])))
	}
	return typedFrom[Highlight](e.Match())
}
...
func (e *HighlightEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HighlightEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HighlightLoadMatch and returns an Highlight. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *HighlightEntity) LoadTyped(reqmatch HighlightLoadMatch, ctrl map[string]any) (Highlight, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Highlight{}, err
	}
	return typedFrom[Highlight](res), nil
}




func (e *HighlightEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// HighlightListMatch and returns []Highlight. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *HighlightEntity) ListTyped(reqmatch HighlightListMatch, ctrl map[string]any) ([]Highlight, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Highlight](res), nil
}



func (e *HighlightEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HighlightEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HighlightEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HighlightEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
