...
type PressReleaseEntity struct {
	name    string
...
func NewPressReleaseEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *PressReleaseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PressReleaseEntity) GetName() string { return e.name }
...
func (e *PressReleaseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PressReleaseEntity) Deleted() bool {
	return e.deleted
}


func (e *PressReleaseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPressReleaseEntity(e.client, opts)
}

func (e *PressReleaseEntity) Data(args ...any) any {
...
func (e *PressReleaseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PressRelease; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PressReleaseEntity) DataTyped(data ...PressRelease) PressRelease {
	if len(data) > 0 {
		return typedFrom[PressRelease](e.Data(asMap(data[0])))
	}
	return typedFrom[PressRelease](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PressRelease (all fields
// optional at the wire level).
func (e *PressReleaseEntity) MatchTyped(match ...PressRelease) PressRelease {
	if len(match) > 0 {
		return typedFrom[PressRelease](e.Match(asMap(match[0])))
	}
	return typedFrom[PressRelease](e.Match())
}
...
func (e *PressReleaseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PressReleaseEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PressReleaseLoadMatch and returns an PressRelease. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PressReleaseEntity) LoadTyped(reqmatch PressReleaseLoadMatch, ctrl map[string]any) (PressRelease, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PressRelease{}, err
	}
	return typedFrom[PressRelease](res), nil
}




func (e *PressReleaseEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PressReleaseListMatch and returns []PressRelease. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PressReleaseEntity) ListTyped(reqmatch PressReleaseListMatch, ctrl map[string]any) ([]PressRelease, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PressRelease](res), nil
}



func (e *PressReleaseEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PressReleaseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PressReleaseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PressReleaseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
