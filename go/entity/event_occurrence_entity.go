...
func NewEventOccurrenceEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *EventOccurrenceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EventOccurrenceEntity) GetName() string { return e.name }
...
func (e *EventOccurrenceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EventOccurrenceEntity) Deleted() bool {
	return e.deleted
}


func (e *EventOccurrenceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEventOccurrenceEntity(e.client, opts)
}

func (e *EventOccurrenceEntity) Data(args ...any) any {
...
func (e *EventOccurrenceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EventOccurrence; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EventOccurrenceEntity) DataTyped(data ...EventOccurrence) EventOccurrence {
	if len(data) > 0 {
		return typedFrom[EventOccurrence](e.Data(asMap(data[0])))
	}
	return typedFrom[EventOccurrence](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EventOccurrence (all fields
// optional at the wire level).
func (e *EventOccurrenceEntity) MatchTyped(match ...EventOccurrence) EventOccurrence {
	if len(match) > 0 {
		return typedFrom[EventOccurrence](e.Match(asMap(match[0])))
	}
	return typedFrom[EventOccurrence](e.Match())
}
...
func (e *EventOccurrenceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EventOccurrenceEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EventOccurrenceLoadMatch and returns an EventOccurrence. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EventOccurrenceEntity) LoadTyped(reqmatch EventOccurrenceLoadMatch, ctrl map[string]any) (EventOccurrence, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return EventOccurrence{}, err
	}
	return typedFrom[EventOccurrence](res), nil
}




func (e *EventOccurrenceEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// EventOccurrenceListMatch and returns []EventOccurrence. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EventOccurrenceEntity) ListTyped(reqmatch EventOccurrenceListMatch, ctrl map[string]any) ([]EventOccurrence, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[EventOccurrence](res), nil
}



func (e *EventOccurrenceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EventOccurrenceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EventOccurrenceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EventOccurrenceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
