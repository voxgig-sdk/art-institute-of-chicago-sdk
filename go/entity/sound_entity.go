...
func NewSoundEntity(client *core.ArtInstituteOfChicagoSDK, entopts map[string]any) *SoundEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SoundEntity) GetName() string { return e.name }
...
func (e *SoundEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SoundEntity) Deleted() bool {
	return e.deleted
}


func (e *SoundEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSoundEntity(e.client, opts)
}

func (e *SoundEntity) Data(args ...any) any {
...
func (e *SoundEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *SoundEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SoundEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *SoundEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SoundEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SoundEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SoundEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
