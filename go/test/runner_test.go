...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("ARTINSTITUTEOFCHICAGO_TEST_LIVE") == "TRUE" ||
		os.Getenv("ARTINSTITUTEOFCHICAGO_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("ARTINSTITUTEOFCHICAGO_TEST_EXPLAIN"); explain != "" {
