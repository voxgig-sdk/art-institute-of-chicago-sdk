...
func TestTourEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		tourRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.tour")))
...
func tourBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("ART_INSTITUTE_OF_CHICAGO_TEST_TOUR_ENTID")
	...
	idmapResolved := core.ToMapAny(env["ART_INSTITUTE_OF_CHICAGO_TEST_TOUR_ENTID"])
