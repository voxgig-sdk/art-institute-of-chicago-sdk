...
const testSeed = `map[string]any{"entity": map[string]any{"agent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "agent_role": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "agent_type": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "article": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "artwork": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "artwork_date_qualifier": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "artwork_place_qualifier": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "artwork_type": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "category_term": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "digital_publication": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "digital_publication_article": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "educator_resource": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "event_occurrence": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "event_program": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "exhibition": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "gallery": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "generic_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "highlight": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "hour": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "image": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "landing_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "place": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "press_release": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "printed_publication": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "product": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "publication": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "section": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "site": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sound": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "static_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "text": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tour": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "video": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
