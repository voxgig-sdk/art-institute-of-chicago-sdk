# ArtInstituteOfChicago SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # ArtInstituteOfChicagoSDK.new, not ArtInstituteOfChicagoSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    ArtInstituteOfChicagoSDK.new(opts)
  end
