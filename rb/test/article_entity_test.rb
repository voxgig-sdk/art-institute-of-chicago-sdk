...
class ArticleEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    article_ref01_list_result, err = article_ref01_ent.list(article_ref01_match, nil)
    assert_nil err
    ...
    article_ref01_data_dt0_loaded, err = article_ref01_ent.load(article_ref01_match_dt0, nil)
    assert_nil err
