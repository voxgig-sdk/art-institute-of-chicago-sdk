...
#      offline in seeded test mode (ArtInstituteOfChicagoSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ArtInstituteOfChicago_sdk.rb")
  SDK_CLASS = "ArtInstituteOfChicagoSDK"
  ...
  SDK_BASE = "ArtInstituteOfChicago_sdk"
