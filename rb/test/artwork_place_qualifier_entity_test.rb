...
class ArtworkPlaceQualifierEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    artwork_place_qualifier_ref01_list_result, err = artwork_place_qualifier_ref01_ent.list(artwork_place_qualifier_ref01_match, nil)
    assert_nil err
    ...
    artwork_place_qualifier_ref01_data_dt0_loaded, err = artwork_place_qualifier_ref01_ent.load(artwork_place_qualifier_ref01_match_dt0, nil)
    assert_nil err
