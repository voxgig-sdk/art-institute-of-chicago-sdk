# ArtInstituteOfChicago SDK Site entity
...
class SiteEntity
  ...
  #   as an empty match, so client.Site.load works with no args).
  ...
  #
  # @param reqmatch [SiteListMatch, Hash, nil] match filter (any subset of
  #   Site fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
