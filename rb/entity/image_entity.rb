# ArtInstituteOfChicago SDK Image entity
...
class ImageEntity
  ...
  # @return [Image, Hash] the loaded Image; raises ArtInstituteOfChicagoError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Image>, Array] the matching Image items; raises ArtInstituteOfChicagoError on failure
