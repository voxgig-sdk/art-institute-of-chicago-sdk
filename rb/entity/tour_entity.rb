# ArtInstituteOfChicago SDK Tour entity
...
class TourEntity
  ...
  # @return [Tour, Hash] the loaded Tour; raises ArtInstituteOfChicagoError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Tour>, Array] the matching Tour items; raises ArtInstituteOfChicagoError on failure
