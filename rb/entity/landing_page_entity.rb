...
class LandingPageEntity
  ...
  def make
    opts = @_entopts.dup
    LandingPageEntity.new(@_client, opts)
  end
  ...
  # @return [LandingPage, Hash] the current LandingPage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of LandingPage fields)
  def match_get
  ...
  #
  # @param reqmatch [LandingPageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.LandingPage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [LandingPage, Hash] the loaded LandingPage; raises ArtInstituteOfChicagoError on failure
  ...
  #
  # @param reqmatch [LandingPageListMatch, Hash, nil] match filter (any subset of
  #   LandingPage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<LandingPage>, Array] the matching LandingPage items; raises ArtInstituteOfChicagoError on failure
