...
class SoundEntity
  ...
  #   as an empty match, so client.Sound.load works with no args).
  ...
  #
  # @param reqmatch [SoundListMatch, Hash, nil] match filter (any subset of
  #   Sound fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
