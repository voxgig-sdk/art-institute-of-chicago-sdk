...
class ExhibitionEntity
  ...
  def make
    opts = @_entopts.dup
    ExhibitionEntity.new(@_client, opts)
  end
  ...
  # @return [Exhibition, Hash] the current Exhibition data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Exhibition fields)
  def match_get
  ...
  #
  # @param reqmatch [ExhibitionLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Exhibition.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Exhibition, Hash] the loaded Exhibition; raises ArtInstituteOfChicagoError on failure
  ...
  #
  # @param reqmatch [ExhibitionListMatch, Hash, nil] match filter (any subset of
  #   Exhibition fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Exhibition>, Array] the matching Exhibition items; raises ArtInstituteOfChicagoError on failure
