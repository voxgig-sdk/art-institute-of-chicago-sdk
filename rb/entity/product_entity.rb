# ArtInstituteOfChicago SDK Product entity
...
class ProductEntity
  ...
  # @return [Product, Hash] the loaded Product; raises ArtInstituteOfChicagoError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Product>, Array] the matching Product items; raises ArtInstituteOfChicagoError on failure
