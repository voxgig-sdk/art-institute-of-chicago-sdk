...
class AgentEntity
  ...
  # @return [Agent, Hash] the current Agent data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Agent fields)
  def match_get
  ...
  # Load a single Agent.
  #
  # @param reqmatch [AgentLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Agent.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Agent, Hash] the loaded Agent; raises ArtInstituteOfChicagoError on failure
  ...
  #
  # @param reqmatch [AgentListMatch, Hash, nil] match filter (any subset of
  #   Agent fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Agent>, Array] the matching Agent items; raises ArtInstituteOfChicagoError on failure
