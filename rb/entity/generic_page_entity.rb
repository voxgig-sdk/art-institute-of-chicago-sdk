...
class GenericPageEntity
  ...
  def make
    opts = @_entopts.dup
    GenericPageEntity.new(@_client, opts)
  end
  ...
  # @return [GenericPage, Hash] the current GenericPage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GenericPage fields)
  def match_get
  ...
  #
  # @param reqmatch [GenericPageLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.GenericPage.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [GenericPage, Hash] the loaded GenericPage; raises ArtInstituteOfChicagoError on failure
  ...
  #
  # @param reqmatch [GenericPageListMatch, Hash, nil] match filter (any subset of
  #   GenericPage fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<GenericPage>, Array] the matching GenericPage items; raises ArtInstituteOfChicagoError on failure
