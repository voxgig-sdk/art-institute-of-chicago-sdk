# ArtInstituteOfChicago SDK Event entity
...
class EventEntity
  ...
  # @return [Event, Hash] the loaded Event; raises ArtInstituteOfChicagoError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Event>, Array] the matching Event items; raises ArtInstituteOfChicagoError on failure
