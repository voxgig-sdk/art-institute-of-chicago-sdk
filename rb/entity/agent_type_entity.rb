...
class AgentTypeEntity
  ...
  def make
    opts = @_entopts.dup
    AgentTypeEntity.new(@_client, opts)
  end
  ...
  # @return [AgentType, Hash] the current AgentType data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AgentType fields)
  def match_get
  ...
  #
  # @param reqmatch [AgentTypeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.AgentType.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [AgentType, Hash] the loaded AgentType; raises ArtInstituteOfChicagoError on failure
  ...
  #
  # @param reqmatch [AgentTypeListMatch, Hash, nil] match filter (any subset of
  #   AgentType fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<AgentType>, Array] the matching AgentType items; raises ArtInstituteOfChicagoError on failure
