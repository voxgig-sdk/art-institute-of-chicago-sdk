...
class ArtworkEntity
  ...
  def make
    opts = @_entopts.dup
    ArtworkEntity.new(@_client, opts)
  end
  ...
  # @return [Artwork, Hash] the current Artwork data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Artwork fields)
  def match_get
  ...
  #
  # @param reqmatch [ArtworkLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Artwork.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Artwork, Hash] the loaded Artwork; raises ArtInstituteOfChicagoError on failure
  ...
  #
  # @param reqmatch [ArtworkListMatch, Hash, nil] match filter (any subset of
  #   Artwork fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Artwork>, Array] the matching Artwork items; raises ArtInstituteOfChicagoError on failure
