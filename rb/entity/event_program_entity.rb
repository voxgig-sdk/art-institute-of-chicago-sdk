...
class EventProgramEntity
  ...
  def make
    opts = @_entopts.dup
    EventProgramEntity.new(@_client, opts)
  end
  ...
  # @return [EventProgram, Hash] the current EventProgram data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EventProgram fields)
  def match_get
  ...
  #
  # @param reqmatch [EventProgramLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.EventProgram.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [EventProgram, Hash] the loaded EventProgram; raises ArtInstituteOfChicagoError on failure
  ...
  #
  # @param reqmatch [EventProgramListMatch, Hash, nil] match filter (any subset of
  #   EventProgram fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<EventProgram>, Array] the matching EventProgram items; raises ArtInstituteOfChicagoError on failure
