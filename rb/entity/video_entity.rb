# ArtInstituteOfChicago SDK Video entity
...
class VideoEntity
  ...
  # @return [Video, Hash] the loaded Video; raises ArtInstituteOfChicagoError on failure
  ...
  # List Video items matching the given filter.
  #
  # @param reqmatch [VideoListMatch, Hash, nil] match filter (any subset of
  #   Video fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Video>, Array] the matching Video items; raises ArtInstituteOfChicagoError on failure
