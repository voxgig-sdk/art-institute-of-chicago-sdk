# ArtInstituteOfChicago SDK Place entity
...
class PlaceEntity
  ...
  # @return [Place, Hash] the loaded Place; raises ArtInstituteOfChicagoError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Place>, Array] the matching Place items; raises ArtInstituteOfChicagoError on failure
