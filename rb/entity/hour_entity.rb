...
class HourEntity
  ...
  # @return [Hour, Hash] the current Hour data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Hour fields)
  def match_get
  ...
  # Load a single Hour.
  #
  # @param reqmatch [HourLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Hour.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Hour, Hash] the loaded Hour; raises ArtInstituteOfChicagoError on failure
  ...
  #
  # @param reqmatch [HourListMatch, Hash, nil] match filter (any subset of
  #   Hour fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Hour>, Array] the matching Hour items; raises ArtInstituteOfChicagoError on failure
