...
class TextEntity
  ...
  #   as an empty match, so client.Text.load works with no args).
  ...
  #
  # @param reqmatch [TextListMatch, Hash, nil] match filter (any subset of
  #   Text fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
