// Command ArtInstituteOfChicago-cli is a CLI + REPL for the ArtInstituteOfChicago SDK,
...
const prompt = "art-institute-of-chicago"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "agent agent_role agent_type article artwork artwork_date_qualifier artwork_place_qualifier artwork_type category_term digital_publication digital_publication_article educator_resource event event_occurrence event_program exhibition gallery generic_page highlight hour image landing_page place press_release printed_publication product publication search section site sound static_page text tour video"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      ART_INSTITUTE_OF_CHICAGO_APIKEY (api key), ART_INSTITUTE_OF_CHICAGO_BASE (base url override)")
