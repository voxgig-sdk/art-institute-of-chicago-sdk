...
local LandingPageEntity = {}
LandingPageEntity.__index = LandingPageEntity


function LandingPageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LandingPageEntity)
  self._name = "landing_page"
  self._client = client
...
function LandingPageEntity:get_name()
  return self._name
end


function LandingPageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LandingPageEntity.new(self._client, opts)
end
...
function LandingPageEntity:mark_deleted()
  self._deleted = true
end


function LandingPageEntity:deleted()
  return true == self._deleted
end


function LandingPageEntity:data_set(args)
  if args ~= nil then
...
function LandingPageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LandingPageEntity:match_set(args)
  if args ~= nil then
...
function LandingPageEntity:match_get()
...
function LandingPageEntity:stream(action, args, callopts)
...
function LandingPageEntity:_run_op(ctx, post_done)
  local utility = self._utility
