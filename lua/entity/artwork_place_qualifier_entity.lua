...
local ArtworkPlaceQualifierEntity = {}
ArtworkPlaceQualifierEntity.__index = ArtworkPlaceQualifierEntity


function ArtworkPlaceQualifierEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ArtworkPlaceQualifierEntity)
  self._name = "artwork_place_qualifier"
  self._client = client
...
function ArtworkPlaceQualifierEntity:get_name()
  return self._name
end


function ArtworkPlaceQualifierEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ArtworkPlaceQualifierEntity.new(self._client, opts)
end
...
function ArtworkPlaceQualifierEntity:mark_deleted()
  self._deleted = true
end


function ArtworkPlaceQualifierEntity:deleted()
  return true == self._deleted
end


function ArtworkPlaceQualifierEntity:data_set(args)
  if args ~= nil then
...
function ArtworkPlaceQualifierEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ArtworkPlaceQualifierEntity:match_set(args)
  if args ~= nil then
...
function ArtworkPlaceQualifierEntity:match_get()
...
function ArtworkPlaceQualifierEntity:stream(action, args, callopts)
...
---@param reqmatch ArtworkPlaceQualifierLoadMatch
---@param ctrl? table
---@return ArtworkPlaceQualifier
---@return string? err
function ArtworkPlaceQualifierEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ArtworkPlaceQualifierListMatch
---@param ctrl? table
---@return ArtworkPlaceQualifier[]
---@return string? err
function ArtworkPlaceQualifierEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ArtworkPlaceQualifierEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ArtworkPlaceQualifierEntity
