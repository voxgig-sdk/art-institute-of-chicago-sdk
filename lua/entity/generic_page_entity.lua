...
local GenericPageEntity = {}
GenericPageEntity.__index = GenericPageEntity


function GenericPageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GenericPageEntity)
  self._name = "generic_page"
  self._client = client
...
function GenericPageEntity:get_name()
  return self._name
end


function GenericPageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GenericPageEntity.new(self._client, opts)
end
...
function GenericPageEntity:mark_deleted()
  self._deleted = true
end


function GenericPageEntity:deleted()
  return true == self._deleted
end


function GenericPageEntity:data_set(args)
  if args ~= nil then
...
function GenericPageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GenericPageEntity:match_set(args)
  if args ~= nil then
...
function GenericPageEntity:match_get()
...
function GenericPageEntity:stream(action, args, callopts)
...
function GenericPageEntity:_run_op(ctx, post_done)
  local utility = self._utility
