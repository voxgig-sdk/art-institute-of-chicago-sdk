...
local DigitalPublicationArticleEntity = {}
DigitalPublicationArticleEntity.__index = DigitalPublicationArticleEntity


function DigitalPublicationArticleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DigitalPublicationArticleEntity)
  self._name = "digital_publication_article"
  self._client = client
...
function DigitalPublicationArticleEntity:get_name()
  return self._name
end


function DigitalPublicationArticleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DigitalPublicationArticleEntity.new(self._client, opts)
end
...
function DigitalPublicationArticleEntity:mark_deleted()
  self._deleted = true
end


function DigitalPublicationArticleEntity:deleted()
  return true == self._deleted
end


function DigitalPublicationArticleEntity:data_set(args)
  if args ~= nil then
...
function DigitalPublicationArticleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DigitalPublicationArticleEntity:match_set(args)
  if args ~= nil then
...
function DigitalPublicationArticleEntity:match_get()
...
function DigitalPublicationArticleEntity:stream(action, args, callopts)
...
---@param reqmatch DigitalPublicationArticleLoadMatch
---@param ctrl? table
---@return DigitalPublicationArticle
---@return string? err
function DigitalPublicationArticleEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch DigitalPublicationArticleListMatch
---@param ctrl? table
---@return DigitalPublicationArticle[]
---@return string? err
function DigitalPublicationArticleEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function DigitalPublicationArticleEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DigitalPublicationArticleEntity
