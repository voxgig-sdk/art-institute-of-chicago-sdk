...
local ArtworkTypeEntity = {}
ArtworkTypeEntity.__index = ArtworkTypeEntity


function ArtworkTypeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ArtworkTypeEntity)
  self._name = "artwork_type"
  self._client = client
...
function ArtworkTypeEntity:get_name()
  return self._name
end


function ArtworkTypeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ArtworkTypeEntity.new(self._client, opts)
end
...
function ArtworkTypeEntity:mark_deleted()
  self._deleted = true
end


function ArtworkTypeEntity:deleted()
  return true == self._deleted
end


function ArtworkTypeEntity:data_set(args)
  if args ~= nil then
...
function ArtworkTypeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ArtworkTypeEntity:match_set(args)
  if args ~= nil then
...
function ArtworkTypeEntity:match_get()
...
function ArtworkTypeEntity:stream(action, args, callopts)
...
function ArtworkTypeEntity:_run_op(ctx, post_done)
  local utility = self._utility
