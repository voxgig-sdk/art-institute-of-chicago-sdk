...
function TextEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TextEntity)
  self._name = "text"
  self._client = client
...
function TextEntity:get_name()
  return self._name
end


function TextEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TextEntity.new(self._client, opts)
end
...
function TextEntity:mark_deleted()
  self._deleted = true
end


function TextEntity:deleted()
  return true == self._deleted
end


function TextEntity:data_set(args)
  if args ~= nil then
...
function TextEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TextEntity:match_set(args)
  if args ~= nil then
...
function TextEntity:stream(action, args, callopts)
...
function TextEntity:_run_op(ctx, post_done)
  local utility = self._utility
