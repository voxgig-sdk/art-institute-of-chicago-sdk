...
local EducatorResourceEntity = {}
EducatorResourceEntity.__index = EducatorResourceEntity


function EducatorResourceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EducatorResourceEntity)
  self._name = "educator_resource"
  self._client = client
...
function EducatorResourceEntity:get_name()
  return self._name
end


function EducatorResourceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EducatorResourceEntity.new(self._client, opts)
end
...
function EducatorResourceEntity:mark_deleted()
  self._deleted = true
end


function EducatorResourceEntity:deleted()
  return true == self._deleted
end


function EducatorResourceEntity:data_set(args)
  if args ~= nil then
...
function EducatorResourceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EducatorResourceEntity:match_set(args)
  if args ~= nil then
...
function EducatorResourceEntity:match_get()
...
function EducatorResourceEntity:stream(action, args, callopts)
...
function EducatorResourceEntity:_run_op(ctx, post_done)
  local utility = self._utility
