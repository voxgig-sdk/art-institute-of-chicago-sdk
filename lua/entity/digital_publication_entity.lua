...
local DigitalPublicationEntity = {}
DigitalPublicationEntity.__index = DigitalPublicationEntity


function DigitalPublicationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DigitalPublicationEntity)
  self._name = "digital_publication"
  self._client = client
...
function DigitalPublicationEntity:get_name()
  return self._name
end


function DigitalPublicationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DigitalPublicationEntity.new(self._client, opts)
end
...
function DigitalPublicationEntity:mark_deleted()
  self._deleted = true
end


function DigitalPublicationEntity:deleted()
  return true == self._deleted
end


function DigitalPublicationEntity:data_set(args)
  if args ~= nil then
...
function DigitalPublicationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DigitalPublicationEntity:match_set(args)
  if args ~= nil then
...
function DigitalPublicationEntity:match_get()
...
function DigitalPublicationEntity:stream(action, args, callopts)
...
function DigitalPublicationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DigitalPublicationEntity
