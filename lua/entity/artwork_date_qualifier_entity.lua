...
local ArtworkDateQualifierEntity = {}
ArtworkDateQualifierEntity.__index = ArtworkDateQualifierEntity


function ArtworkDateQualifierEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ArtworkDateQualifierEntity)
  self._name = "artwork_date_qualifier"
  self._client = client
...
function ArtworkDateQualifierEntity:get_name()
  return self._name
end


function ArtworkDateQualifierEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ArtworkDateQualifierEntity.new(self._client, opts)
end
...
function ArtworkDateQualifierEntity:mark_deleted()
  self._deleted = true
end


function ArtworkDateQualifierEntity:deleted()
  return true == self._deleted
end


function ArtworkDateQualifierEntity:data_set(args)
  if args ~= nil then
...
function ArtworkDateQualifierEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ArtworkDateQualifierEntity:match_set(args)
  if args ~= nil then
...
function ArtworkDateQualifierEntity:match_get()
...
function ArtworkDateQualifierEntity:stream(action, args, callopts)
...
---@param reqmatch ArtworkDateQualifierLoadMatch
---@param ctrl? table
---@return ArtworkDateQualifier
---@return string? err
function ArtworkDateQualifierEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ArtworkDateQualifierListMatch
---@param ctrl? table
---@return ArtworkDateQualifier[]
---@return string? err
function ArtworkDateQualifierEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ArtworkDateQualifierEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ArtworkDateQualifierEntity
