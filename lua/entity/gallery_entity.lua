...
local GalleryEntity = {}
GalleryEntity.__index = GalleryEntity


function GalleryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GalleryEntity)
  self._name = "gallery"
  self._client = client
...
function GalleryEntity:get_name()
  return self._name
end


function GalleryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GalleryEntity.new(self._client, opts)
end
...
function GalleryEntity:mark_deleted()
  self._deleted = true
end


function GalleryEntity:deleted()
  return true == self._deleted
end


function GalleryEntity:data_set(args)
  if args ~= nil then
...
function GalleryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GalleryEntity:match_set(args)
  if args ~= nil then
...
function GalleryEntity:match_get()
...
function GalleryEntity:stream(action, args, callopts)
...
---@param reqmatch GalleryLoadMatch
---@param ctrl? table
---@return Gallery
---@return string? err
function GalleryEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch GalleryListMatch
---@param ctrl? table
---@return Gallery[]
---@return string? err
function GalleryEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function GalleryEntity:_run_op(ctx, post_done)
  local utility = self._utility
