...
The Lua SDK for the ArtInstituteOfChicago API. Provides an entity-oriented interface using Lua conventions.
...
local result, err = client:ArtInstituteOfChicago(nil):load(
  { id = "test01" }, nil
)
