-- DigitalPublication direct test
...
describe("DigitalPublicationDirect", function()
  it("should direct-list-digital_publication", function()
    local setup = digital_publication_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-digital_publication", setup.live and "live" or "unit")
  ...
  it("should direct-load-digital_publication", function()
    local setup = digital_publication_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-digital_publication", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function digital_publication_direct_setup(mockres)
