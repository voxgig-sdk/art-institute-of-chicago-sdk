...
describe("VideoDirect", function()
  it("should direct-list-video", function()
    local setup = video_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-video", setup.live and "live" or "unit")
