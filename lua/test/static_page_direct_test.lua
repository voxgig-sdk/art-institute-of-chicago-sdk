...
describe("StaticPageDirect", function()
  it("should direct-list-static_page", function()
    local setup = static_page_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-static_page", setup.live and "live" or "unit")
  ...
  it("should direct-load-static_page", function()
    local setup = static_page_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-static_page", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function static_page_direct_setup(mockres)
