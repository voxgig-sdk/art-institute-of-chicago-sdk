...
describe("EducatorResourceDirect", function()
  it("should direct-list-educator_resource", function()
    local setup = educator_resource_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-educator_resource", setup.live and "live" or "unit")
  ...
  it("should direct-load-educator_resource", function()
    local setup = educator_resource_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-educator_resource", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function educator_resource_direct_setup(mockres)
