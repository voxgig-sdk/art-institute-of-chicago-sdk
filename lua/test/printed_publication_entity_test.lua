...
describe("PrintedPublicationEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ART_INSTITUTE_OF_CHICAGO_TEST_PRINTED_PUBLICATION_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    local printed_publication_ref01_data_dt0_load_result = helpers.to_map(type(printed_publication_ref01_data_dt0_loaded) == 'table' and printed_publication_ref01_data_dt0_loaded.data_get and printed_publication_ref01_data_dt0_loaded:data_get() or printed_publication_ref01_data_dt0_loaded)
...
function printed_publication_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ART_INSTITUTE_OF_CHICAGO_TEST_PRINTED_PUBLICATION_ENTID")
