...
describe("LandingPageEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ART_INSTITUTE_OF_CHICAGO_TEST_LANDING_PAGE_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    local landing_page_ref01_data_dt0_load_result = helpers.to_map(type(landing_page_ref01_data_dt0_loaded) == 'table' and landing_page_ref01_data_dt0_loaded.data_get and landing_page_ref01_data_dt0_loaded:data_get() or landing_page_ref01_data_dt0_loaded)
...
function landing_page_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ART_INSTITUTE_OF_CHICAGO_TEST_LANDING_PAGE_ENTID")
