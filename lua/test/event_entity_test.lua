...
describe("EventEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ARTINSTITUTEOFCHICAGO_TEST_EVENT_ENTID JSON to run live")
      return
    end
...
function event_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ARTINSTITUTEOFCHICAGO_TEST_EVENT_ENTID")
