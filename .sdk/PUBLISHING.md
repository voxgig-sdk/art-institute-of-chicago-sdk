...
|---|---|---|
| `ts/` | @voxgig-sdk/art-institute-of-chicago-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/art-institute-of-chicago-sdk \
      --repository voxgig-sdk/art-institute-of-chicago-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/art-institute-of-chicago-sdk` shows it, and
`npm trust revoke @voxgig-sdk/art-institute-of-chicago-sdk --id=<id>` removes it.
