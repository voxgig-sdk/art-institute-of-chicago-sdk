...
def make_error_util(ctx, err):
    if ctx is None:
        ...
        ctx = ArtInstituteOfChicagoContext({}, None)
    ...
    result = ctx.result
    if result is None:
        result = ArtInstituteOfChicagoResult({})
    result.ok = False
    ...
    errmsg = ""
    if isinstance(err, ArtInstituteOfChicagoError):
        errmsg = err.msg
    ...
    sdk_err = ArtInstituteOfChicagoError("", msg, ctx)
