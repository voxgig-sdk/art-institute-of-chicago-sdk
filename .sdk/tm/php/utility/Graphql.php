...
// ArtInstituteOfChicago SDK utility: graphql
//
...
class ArtInstituteOfChicagoGraphql
{
    ...
    // equivalent.
    public static function body(ArtInstituteOfChicagoContext $ctx): mixed
    {
    ...
    public static function errors(ArtInstituteOfChicagoContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
