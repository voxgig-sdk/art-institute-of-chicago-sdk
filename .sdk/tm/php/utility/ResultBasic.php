...
// ArtInstituteOfChicago SDK utility: result_basic

class ArtInstituteOfChicagoResultBasic
{
    public static function call(ArtInstituteOfChicagoContext $ctx): ?ArtInstituteOfChicagoResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof ArtInstituteOfChicagoError) ? $result->err->msg : (string)$result->err;
