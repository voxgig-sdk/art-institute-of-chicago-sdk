...
// ArtInstituteOfChicago SDK utility: fetcher

class ArtInstituteOfChicagoFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ArtInstituteOfChicagoSDK/1.0)';
    ...
    public static function call(ArtInstituteOfChicagoContext $ctx, string $fullurl, array $fetchdef): array
    {
