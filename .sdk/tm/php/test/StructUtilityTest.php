...
// ArtInstituteOfChicago SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ArtInstituteOfChicagoOmni::makeStructRunner(
    ...
    {
        return ArtInstituteOfChicagoOmni::objmodel(ArtInstituteOfChicagoOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return ArtInstituteOfChicagoOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return ArtInstituteOfChicagoOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ArtInstituteOfChicagoOmni::structfix($now, Struct::undef()))
                        !== json_encode(ArtInstituteOfChicagoOmni::structfix($val, Struct::undef()))) {
