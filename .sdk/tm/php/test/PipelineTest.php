...
// ArtInstituteOfChicago SDK pipeline test
//
...
{
    private static function utility(): ArtInstituteOfChicagoUtility
    {
        return new ArtInstituteOfChicagoUtility();
    }
    ...
    private static function ctx(array $over = []): ArtInstituteOfChicagoContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ArtInstituteOfChicagoContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ArtInstituteOfChicagoOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ArtInstituteOfChicagoError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ArtInstituteOfChicagoOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ArtInstituteOfChicagoMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ArtInstituteOfChicagoOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ArtInstituteOfChicagoMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ArtInstituteOfChicagoOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ArtInstituteOfChicagoMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ArtInstituteOfChicagoSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ArtInstituteOfChicagoMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        ...
        [, $err] = ArtInstituteOfChicagoMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ArtInstituteOfChicagoSpec([]),
            'response' => null,
            'result' => new ArtInstituteOfChicagoResult([]),
        ]);
        [, $err] = ArtInstituteOfChicagoMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ArtInstituteOfChicagoSpec(['step' => 's']),
            'response' => new ArtInstituteOfChicagoResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ArtInstituteOfChicagoResult([]),
        ]);
        [, $err] = ArtInstituteOfChicagoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ArtInstituteOfChicagoSpec(['step' => 's']),
            'response' => new ArtInstituteOfChicagoResponse(self::resp(200, ['v' => 1])),
            'result' => new ArtInstituteOfChicagoResult([]),
        ]);
        [, $err] = ArtInstituteOfChicagoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ArtInstituteOfChicagoSpec(['step' => 's']),
            'response' => new ArtInstituteOfChicagoResponse(self::resp(200, ['v' => 2])),
            'result' => new ArtInstituteOfChicagoResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ArtInstituteOfChicagoMakeResponse::call($ctx);
    ...
    {
        $preset = new ArtInstituteOfChicagoResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ArtInstituteOfChicagoSpec([]),
            'response' => new ArtInstituteOfChicagoResponse([]),
            'result' => new ArtInstituteOfChicagoResult([]),
        ...
        [$got, $err] = ArtInstituteOfChicagoMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ArtInstituteOfChicagoResult([])]);
        [, $err] = ArtInstituteOfChicagoMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ArtInstituteOfChicagoSpec([]), 'result' => null]);
        [, $err] = ArtInstituteOfChicagoMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ArtInstituteOfChicagoSpec(['step' => 's']),
            'result' => new ArtInstituteOfChicagoResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ArtInstituteOfChicagoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ArtInstituteOfChicagoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ArtInstituteOfChicagoSpec(['step' => 's']),
            'result' => new ArtInstituteOfChicagoResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ArtInstituteOfChicagoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ArtInstituteOfChicagoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ArtInstituteOfChicagoResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ArtInstituteOfChicagoSpec([]),
            'result' => new ArtInstituteOfChicagoResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ArtInstituteOfChicagoMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ArtInstituteOfChicagoMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ArtInstituteOfChicagoError('boom', 'boom');
        $utility->fetcher = function (ArtInstituteOfChicagoContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ArtInstituteOfChicagoSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ArtInstituteOfChicagoMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ArtInstituteOfChicagoContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ArtInstituteOfChicagoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ArtInstituteOfChicagoResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ArtInstituteOfChicagoMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ArtInstituteOfChicagoContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ArtInstituteOfChicagoSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ArtInstituteOfChicagoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ArtInstituteOfChicagoResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ArtInstituteOfChicagoSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ArtInstituteOfChicagoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ArtInstituteOfChicagoMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ArtInstituteOfChicagoMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ArtInstituteOfChicagoResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ArtInstituteOfChicagoDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ArtInstituteOfChicagoResult(['ok' => false])]);
        $this->expectException(ArtInstituteOfChicagoError::class);
        ArtInstituteOfChicagoDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ArtInstituteOfChicagoResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ArtInstituteOfChicagoMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ArtInstituteOfChicagoMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ArtInstituteOfChicagoBaseFeature();
        $b = new ArtInstituteOfChicagoBaseFeature();
        ArtInstituteOfChicagoFeatureAdd::call($ctx, $a);
        ArtInstituteOfChicagoFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ArtInstituteOfChicagoBaseFeature
    {
        $f = new ArtInstituteOfChicagoBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ArtInstituteOfChicagoFeatureAdd::call($ctx, self::named_feature('a'));
        ArtInstituteOfChicagoFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        ArtInstituteOfChicagoFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        ArtInstituteOfChicagoFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        ArtInstituteOfChicagoFeatureAdd::call($ctx, $replace);
        ...
        ArtInstituteOfChicagoFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ArtInstituteOfChicagoContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ArtInstituteOfChicagoSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ArtInstituteOfChicagoPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ArtInstituteOfChicagoPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ArtInstituteOfChicagoResponse(['headers' => null]),
            'result' => new ArtInstituteOfChicagoResult([]),
        ]);
        ArtInstituteOfChicagoResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ArtInstituteOfChicagoResultBody::call($ctx);
