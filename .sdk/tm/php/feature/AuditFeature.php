...
// ArtInstituteOfChicago SDK audit feature
...
class ArtInstituteOfChicagoAuditFeature extends ArtInstituteOfChicagoBaseFeature
{
    ...
    private function _emit(ArtInstituteOfChicagoContext $ctx, string $outcome): void
    {
