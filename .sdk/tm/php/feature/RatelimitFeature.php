...
// ArtInstituteOfChicago SDK ratelimit feature
...
class ArtInstituteOfChicagoRatelimitFeature extends ArtInstituteOfChicagoBaseFeature
{
    ...
    private function _acquire(ArtInstituteOfChicagoContext $ctx): void
    {
    ...
    private function _track(ArtInstituteOfChicagoContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
