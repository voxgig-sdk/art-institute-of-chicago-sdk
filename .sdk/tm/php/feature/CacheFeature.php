...
// ArtInstituteOfChicago SDK cache feature
...
class ArtInstituteOfChicagoCacheFeature extends ArtInstituteOfChicagoBaseFeature
{
    ...
    private function _through(ArtInstituteOfChicagoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
