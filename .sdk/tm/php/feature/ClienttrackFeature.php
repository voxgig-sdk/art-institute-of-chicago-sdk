...
// ArtInstituteOfChicago SDK clienttrack feature
...
class ArtInstituteOfChicagoClienttrackFeature extends ArtInstituteOfChicagoBaseFeature
{
    ...
    public function PostConstruct(ArtInstituteOfChicagoContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ArtInstituteOfChicago-SDK';
