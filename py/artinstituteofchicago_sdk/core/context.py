...
from artinstituteofchicago_sdk.core.helpers import get_ctx_prop, to_map
...
class ArtInstituteOfChicagoContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ArtInstituteOfChicagoControl()
        ...
        if isinstance(sp, ArtInstituteOfChicagoSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ArtInstituteOfChicagoResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ArtInstituteOfChicagoResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ArtInstituteOfChicagoOperation({})
        ...
        op = ArtInstituteOfChicagoOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return ArtInstituteOfChicagoError(code, msg, self)
