...
class ArtworkDateQualifierEntity:
    ...
    def load(self, reqmatch: ArtworkDateQualifierLoadMatch, ctrl=None) -> ArtworkDateQualifier:
    ...
    def list(self, reqmatch: ArtworkDateQualifierListMatch, ctrl=None) -> list[ArtworkDateQualifier]:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "list",
            "ctrl": ctrl,
