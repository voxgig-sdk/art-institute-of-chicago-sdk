...
class DigitalPublicationEntity:
    ...
    def load(self, reqmatch: DigitalPublicationLoadMatch, ctrl=None) -> DigitalPublication:
    ...
    def list(self, reqmatch: DigitalPublicationListMatch, ctrl=None) -> list[DigitalPublication]:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "list",
            "ctrl": ctrl,
