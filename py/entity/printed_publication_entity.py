...
class PrintedPublicationEntity:
    ...
    def load(self, reqmatch: PrintedPublicationLoadMatch, ctrl=None) -> PrintedPublication:
    ...
    def list(self, reqmatch: PrintedPublicationListMatch, ctrl=None) -> list[PrintedPublication]:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "list",
            "ctrl": ctrl,
