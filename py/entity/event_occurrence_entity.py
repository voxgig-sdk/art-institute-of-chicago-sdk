...
class EventOccurrenceEntity:
    ...
    def load(self, reqmatch: EventOccurrenceLoadMatch, ctrl=None) -> EventOccurrence:
    ...
    def list(self, reqmatch: EventOccurrenceListMatch, ctrl=None) -> list[EventOccurrence]:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "list",
            "ctrl": ctrl,
