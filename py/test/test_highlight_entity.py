    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set ART_INSTITUTE_OF_CHICAGO_TEST_HIGHLIGHT_ENTID JSON to run live")
        client = setup["client"]
        ...
        highlight_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(highlight_ref01_data_dt0_loaded))
...
def _highlight_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("ART_INSTITUTE_OF_CHICAGO_TEST_HIGHLIGHT_ENTID"))
