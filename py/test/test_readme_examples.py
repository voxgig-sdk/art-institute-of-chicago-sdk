# ArtInstituteOfChicago SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ArtInstituteOfChicagoSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ArtInstituteOfChicagoSDK(...) and ArtInstituteOfChicagoSDK.test(...) become
#      ArtInstituteOfChicagoSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "artinstituteofchicago_sdk"
_SDK_CLASS = "ArtInstituteOfChicagoSDK"
...
_ENTITIES = {
    ...
    "Article": "article",
    "Artwork": "artwork",
    "ArtworkDateQualifier": "artwork_date_qualifier",
    "ArtworkPlaceQualifier": "artwork_place_qualifier",
    "ArtworkType": "artwork_type",
    "CategoryTerm": "category_term",
    "DigitalPublication": "digital_publication",
    "DigitalPublicationArticle": "digital_publication_article",
    "EducatorResource": "educator_resource",
    "Event": "event",
    ...
    "PrintedPublication": "printed_publication",
    "Product": "product",
